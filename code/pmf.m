function prediction = pmf(data, idSensor, observacion, maxepoch)
  ...
  num_m = size(data,2);
  num_p = size(data,1);
  num_feat = 4;  % AUTOMATIZAR ESTO, ES LA K DEL PAPER
  ...
  for epoch = epoch:maxepoch
    ...
    % JOSE: Guarda para evitar que se vaya a infinito
