...
% OUTPUT :
%
% moments    nk by 3      matrix of moments estimate at each nk estimation points.
%                         The moments are the BME mean, 
%                         the BME estimation error variance (if options(8)>=2)
%                         and the coeff of skewness (if options(8)>=3)
