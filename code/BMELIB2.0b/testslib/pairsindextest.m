...
if testAccuracy
  ...
  for ir=1:nr
    if same(sortrows(idxpairskron{ir}),sortrows(index{ir})),
  ...
  for ir=1:nr
    if same(sortrows(idxpairskronloop{ir}),sortrows(index{ir})),
  ...
  for ir=1:nr
    if same(sortrows(idxpairssuperblock{ir}),sortrows(index{ir})),
